...
<table border="1" cellspacing="0" cellpadding="5">
                ...
                <?php  foreach ($persons as $person) { ?>
                    <tr>
                        ...
                        <td><a href="detail.php?id=<?= $person['id'] ?>">details</a></td>
                        <td><a href="update.php?id=<?= $person['id'] ?>">edit</a></td>
                        <td><a href="delete.php?id=<?= $person['id'] ?>">delete</a></td>
                        <td><a href="moderator.php?id=<?= $person['id'] ?>">moderator</a></td>
                ...
                <?php } ?>
                <tr><td><input type="submit" value="Logout" name="logout" /></td></tr>
     </table>  
     </fieldset>
     </form>
